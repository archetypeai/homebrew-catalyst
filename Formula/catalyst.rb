class Catalyst < Formula
  ...
  url "https://catalyst-releases-archetypeai.s3.us-west-2.amazonaws.com/v0.1.0/catalyst_loop-0.1.0.tar.gz"
  ...
  resource "cortex-client" do
    url "https://catalyst-releases-archetypeai.s3.us-west-2.amazonaws.com/v0.1.0/cortex_client-0.1.0.tar.gz"
