class CatalystEdge < Formula
  ...
  url "https://d9pwqft6ad7vm.cloudfront.net/v0.2.0-rc.94/catalyst-darwin-arm64.tar.gz?key=#{@@release_key}"
  sha256 "102df5ffa3303fd87444ef267974739a479b210634b26574242ca6abe05784c3"
